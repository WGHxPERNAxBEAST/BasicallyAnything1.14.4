package WGHxPERNAxBEAST.BasicallyAnything.client.models;
...
public class TutEntityModel extends EntityModel<TutEntity> {
    ...
    @Override
    public void render(TutEntity entity, float f, float f1, float f2, float f3, float f4, float f5) { 
