...
import static WGHxPERNAxBEAST.BasicallyAnything.lists.BlockList.GENERATORBLOCK_CONTAINER;
...
public class GeneratorBlockContainer extends Container {
    ...
    public GeneratorBlockContainer(int windowId, World world, BlockPos pos, PlayerInventory playerInventory, PlayerEntity player) {
        super(GENERATORBLOCK_CONTAINER, windowId);
    ...
    public boolean canInteractWith(PlayerEntity playerIn) {
        return isWithinUsableDistance(IWorldPosCallable.of(tileEntity.getWorld(), tileEntity.getPos()), playerEntity, BlockList.GENERATORBLOCK);
    }
